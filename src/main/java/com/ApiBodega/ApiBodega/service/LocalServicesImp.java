...
import com.ApiBodega.ApiBodega.repository.LocalRepository;
...
@Service
public class LocalServicesImp implements LocalService{
    ...
    @Override
    public Optional<Local> findLocalNameIgnoreCase(String name) {
